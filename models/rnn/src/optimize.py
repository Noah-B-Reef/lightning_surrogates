...
def suggest_params(trial):
    ...
    return {
        "rnn_num_layers": trial.suggest_int(
            "rnn_num_layers",
            search["rnn_num_layers"]["low"],
            search["rnn_num_layers"]["high"],
        ),
        "rnn_hidden_dim": trial.suggest_int(
            "rnn_hidden_dim",
            search["rnn_hidden_dim"]["low"],
            search["rnn_hidden_dim"]["high"],
            step=search["rnn_hidden_dim"]["step"],
        ),
...
def save_best_params(best_params, results_dir, best_value):
    ...
    with txt_path.open("w") as f:
        f.write(f"rnn_num_layers={best_params['rnn_num_layers']}\n")
        f.write(f"rnn_hidden_dim={best_params['rnn_hidden_dim']}\n")
